pub mod complex {
    ...
    pub trait ComplexComparisons {
        ...
        fn is infinite(self) -> bool;
        fn is_zero(self) -> bool;
        fn is_one(self) -> bool;
        fn is_i(self) -> bool;
        fn is_real(self) -> bool;
        fn is_imaginary(self) -> bool;
        fn is_equal(self, other: Self, tol: Float256) -> bool;
    }
    impl ComplexComparisons for Complex256 {
        ...
        fn is_zero(self) -> bool {
            if self.re == Float256::from(0.0) && self.im == Float256::from(0.0) {
                true
            } else {
                false
            }
        ...
        fn is_one(self) -> bool {
            if self.re == Float256::from(1.0) && self.im == Float256::from(0.0) {
            true
            } else {
                false
        }
        fn is_i(self) -> bool {
            if self.re == Float256::from(0.0) && self.im == Float256::from(1.0) {
                true
            } else {
                false
            }
        ...
        fn is_equal(self, other: Self, tol: Float256) -> bool {
             // add implementation code here, for now use placeholder
            false
        }
    }
